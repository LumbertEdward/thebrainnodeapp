...
/* GET Farmer. */
router.post('/register', urlencodedParser, FarmerRegister) //register farmer
...
router.post('/products/addproduct', urlencodedParser, AddProduct) //add a product
...
router.post('/trainings/add', CreateTraining) //create a training program
router.get('/trainings/:training_id/details', TrainingDetails) //view details of a training program
router.post('/trainings/:training_id/update', UpdateTraining) //update details of a training program by admin only
router.post('/trainings/:training_id/attend', EnrollForTrainings) //enroll for a training
...
router.post('/recommendedcrops/add', NewRecommendation) //add recommended crops by admin
router.post('/recommendedcrops/search/byrainfall', RecommendByRainfall) //recommend best crops by rainfall
router.post('/recommendedcrops/search/bytemperature', RecommendByTemperature) //recommend best crops by temperature
router.post('/recommendedcrops/search/bysoiltype', RecommendBySoilType) //recommend best crops by soil type
...
router.post('/recommendedfarminput/add', AddFarmInput) //add recommended farm input by admin
router.get('/recommendedfarminput/Recommendations/all', AllRecommendations) //view all farm input recommendations
router.post('/recommendedfarminput/search/byequipment', RecommendedEquipment) //search farm inputs by equipment
router.post('/recommendedfarminput/search/byfeed', RecommendedFeed) //search recommended farm input by feed
router.post('/recommendedfarminput/search/byseed', RecommendedSeed) //search recommended farm input by seed
router.post('/recommendedfarminput/search/byenergy', RecommendedEnergy) //search recommended farm input by energy
...
router.post('/:farmer_id/yields/add', AddYields) //add farmer yields
